// Generated by SolidPython 1.1.3 on 2025-10-24 10:53:07
$fa = 0.4; $fs = 0.4;
...
rotate(a = 0, v = [1, 0, 0]) {
	difference() {
			...
			difference() {
				linear_extrude(height = 1.5000000000) {
					offset(r = 1.0000000000) {
						import(file = "C:/Users/tim/Documents/CAN-Accessories-2026/New CAN Accessories board/New CAN Accessories board-EdgeCuts.dxf", origin = [0, 0]);
					}
				}
		...
		linear_extrude(center = true, height = 0.8000000000) {
			translate(v = [0, 0, 0]) {
				import(file = "C:/Users/tim/Documents/CAN-Accessories-2026/New CAN Accessories board/New CAN Accessories board-PasteBottom.dxf", origin = [0, 0]);
			}
		}
	}
}
